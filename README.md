...
// Accessibility is basically allowing people who are using different devices or who have impairments to more easily access your content.

2. Talk about 3 different things you can do to ensure your website is accessible. 

// Add @media to CSS to make sure the images show correcly when minimizing the page itself.
// providing transcripts for audio for hearing impaired.
// Picking the right colors of website to make sure the site is readable.
